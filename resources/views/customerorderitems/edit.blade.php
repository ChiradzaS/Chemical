...
<input name="ordersId"  class="form-control form-control-sm"   value="{{ $order_item->ordersId }}" placeholder="Quantity">
@error('quantity')
...
<input name="quantity"  class="form-control form-control-sm"   value="{{ $order_item->quantity }}" placeholder="Quantity">
@error('quantity')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
...
<div class="form-group">
<strong>other:</strong>
<input   name="other" class="form-control form-control-sm"   value="{{ $order_item->other }}" placeholder="other">
@error('other')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
