...
<head>
    ...
    <title>Orderlist React</title>
    
        <!-- @viteReactRefresh
        @vite(['resources/css/app.css', 'resources/js/reactorderlist.tsx']) -->

{{-- Use the compiled assets instead --}}
<link rel="stylesheet" href="{{ asset('public/build/assets/app-C0XZJsRc.css') }}">
<script src="{{ asset('public/build/assets/reactorderlist-B4M7RAz6.js') }}" type="module" ></script>
