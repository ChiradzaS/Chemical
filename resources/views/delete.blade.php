...
<select  name="qntId"  class="form-control form-control-sm">
@foreach($unittypes as $unittype)
<option value="{{ $unittype->id }}"  @if($unittype->name==$unittype->id) selected @endif>{{ $unittype->name }}</option>
@endforeach
</select>
</div>
...
<option value="{{ $processtype->id }}"  @if($processtype->name==$processtype->id) selected @endif>{{ $processtype->name }}</option>
@endforeach
</select>
</div>
