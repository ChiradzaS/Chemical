...
public static function deliveryinvoice(Request $request) { 
...
$totalexclVAT =  $total - $totalVat;
   ...
   //$customer = $deliverinfo->customerId;
      ...
      //Log::info ('QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQOOOOOOOOAAAAAAAAAAAAAAAAAAAAAA'.$deliveries);
  ...
  $tmpY = $pdf->getY();
    ...
    // $pdf->Ln();
     ...
     $pdf->Cell(192,12,'Tax Invoice To : '.$custval,1,0,'C');
     $pdf->Ln();
     $pdf->SetFont('Arial','',7);
     $id = 134;
