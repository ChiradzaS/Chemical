...
include '/App/Print/php_barcode.php';
...
class PdfPrint extends Fpdf
{
    ...
    static public function digit_to_fpdf_renderer( $pdf, $color, $x, $y, $angle, $type, $datas, $width = null, $height = null )
    {
        ...
        include(app_path() . 'App\Print\php_barcode.php');
        ...
        else
        {
            ...
            include(app_path() . '\Print\php_barcode.php');
...
public static function Method(Request $request) {
    ...
    $pdf->Cell(12,4,'item Id : ',1);

    $pdf->Cell(18,4,'Jobacard Id: ',1);

    $pdf->Cell(18,4,'Product Id:',1);

    $pdf->Cell(18,4,'Name: ',1);

    $pdf->Cell(18,4,'Process:',1);

    $pdf->Cell(20,4,'Barcode:',1);

    $pdf->Cell(18,4,'state:',1);

    $pdf->Cell(18,4,'Other:',1);

 

    $pdf->Cell(18,4,'Quantity:',1);

    $pdf->Cell(18,4,'Quantity Type: ',1);
    ...
    $dataPP = $packagingProductPersist->fpdfObjectsByProductId($request);
    $sizesList = array(25, 50, 25, 25, 25, 25);
    $pdf->BasicTableWithSizes($headerPackingProduct, $dataPP,$sizesList);
